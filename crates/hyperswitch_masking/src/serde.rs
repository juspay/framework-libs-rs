...
pub use serde::{Deserialize, Serialize, Serializer, de};
use serde_json::{Value, value::Serializer as JsonValueSerializer};
...
mod pii_serializer {
    ...
    use serde_json::{Map, Value, value::Serializer as JsonValueSerializer};
